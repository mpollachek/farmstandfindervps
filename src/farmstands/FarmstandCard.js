...
const FarmstandCard = ({ item, favorite, getFavorites, setRunGet }) => {
  ...
  const imageLink = `http://http://localhost:8080/public/images/${_id}/${images[0]}`;
  ...
  // const testImage2 = `http://http://localhost:8080/public/images/63ae1562439a346736c442fb/1672353122205.jpg`;
